package zrock.application.engine.view.menu;

import zrock.application.scriptme.R;

import java.util.HashMap;

import zrock.application.engine.view.menu.RadialMenuColors;
...
public class SemiCircularRadialMenu extends View {
	...
	private int centerRadialColor = Color.BLACK;	
	...
	private void init() {
		...
		mRadialMenuPaint.setColor(Color.BLACK);
	}
