...
public class NavigationDrawerListEditor extends ListFragment implements AbsListView.MultiChoiceModeListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        // Out custom layout
        View rootView = inflater.inflate(R.layout.fragment_navigation_drawer_editor, container, false);
        return rootView;
    }
